...
const Profile = () => {
  ...
  const isFollowing =
    userProfile?.followers?.some((follower) => {
      const followerId =
    ...
    try {
      ...
      if (response.data.success) {
        ...
        const updatedFollowers = currentlyFollowing
          ? userProfile.followers.filter((follower) => {
              const followerId =
                typeof follower === "object" ? follower?._id : follower;
        ...
        const updatedFollowing = currentlyFollowing
          ? (user.following || []).filter(
              (followingId) =>
                followingId?.toString() !== userProfile._id?.toString(),
            )
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-3 px-5 py-6 sm:gap-5">
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gray-100 transition group-hover:scale-105 sm:h-16 sm:w-16">
